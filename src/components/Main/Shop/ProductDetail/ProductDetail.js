...
export default class ProductDetail extends Component {
    render() { 
        ...
        const product = { 
            ...
            material: navigation.getParam('material'), 
                ...
                <View style={cardStyle}>
                    ...
                    <View style={imageContainer}>
                        <ScrollView style={{ flexDirection: 'row', padding: 10, height: swiperHeight }} horizontal >
                            <Image source={{ uri: `${url}${navigation.getParam('images')[0]}` }} style={productImageStyle} />
                            <Image source={{ uri: `${url}${navigation.getParam('images')[1]}` }} style={productImageStyle} />
                        </ScrollView>
                    </View>
                    <View style={footer}>
                        <View style={titleContainer}>
                            <Text style={textMain}>
                                ...
                                <Text style={textSmoke}>{navigation.getParam('price')}$</Text>
                            </Text>
                        </View>
