            ...
            <View style={wrapper}>
                <View style={mapContainer}>
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 21.585045,
                            longitude: 105.8041923,
                            latitudeDelta: 0.0922,
                            longitudeDelta: 0.0421,
                        }}
                    >
                        <MapView.Marker
                            coordinate={{ latitude: 21.585045, longitude: 105.8041923 }}
                            title="Son Trinh"
                            description="Son Coder"
                        />
                    </MapView>
                </View>
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>Z115 / Thai Nguyen</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0969530205</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>tqcaoson@gmail.com</Text>
                    </View>
